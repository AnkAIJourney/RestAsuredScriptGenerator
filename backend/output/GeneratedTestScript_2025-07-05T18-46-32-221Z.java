...
public class InvestmentPlansAPI {
    ...
    public ValidatableResponse callWFECalculateServiceWithoutToken(String requestBody) {
        RequestSpecBuilder builder = new RequestSpecBuilder();
        String url = "https://localhost:7257/api/v1/investment-plans/CallWFECalculateService?assetClassGoupId=ACG-USA-BROAD-2&forecastType=current&IsGraph=1";
        builder.addHeader("Content-Type", "application/json");
        builder.setBody(requestBody);
    ...
    public ValidatableResponse callWFECalculateServiceWithIncorrectParams(String jwtToken, String requestBody, String assetClassGoupId, String isGraph) {
        RequestSpecBuilder builder = new RequestSpecBuilder();
...
public class InvestmentPlansTests extends AbstractTest {
    ...
    public void test_8() throws Exception {
        ...
        String jsonContent = new String(Files.readAllBytes(Paths.get(jsonFilePath)));
        ValidatableResponse jwtToken = jwtTokenAPI.jwtTokenWithValidRoles();
        ValidatableResponse response = api.callWFECalculateService(jwtToken.extract().jsonPath().getString("jwtToken"), "{ \"invalid\": \"data\" }");
        response.statusCode(500);
    }
