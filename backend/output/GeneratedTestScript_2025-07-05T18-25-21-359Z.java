1. Methods: package com.morningstar.automation.aws3.api.ipx;
...
2. Tests: package com.morningstar.automation.aws3.test.ipx;
...
public class AWS3_IPX_Reports extends AbstractTest {
    ...
    public void verifyBenchmarkId_AutoAsset() throws IOException {
        ...
        jsonContent = jsonContent.replace("currentBenchmarkIdValue", "AutoAsset")
                                 .replace("proposedBenchmarkIdValue", "AutoAsset");
    ...
    public void verifyBenchmarkId_dcc56cad() throws IOException {
        ...
        String jsonFilePath = "src\\test\\resources\\testData\\RequestData\\ipx\\getXml.json";
        String jsonContent = new String(Files.readAllBytes(Paths.get(jsonFilePath)));
        jsonContent = jsonContent.replace("currentBenchmarkIdValue", "dcc56cad-a24f-4d93-9522-86435029d494")
                                 .replace("proposedBenchmarkIdValue", "dcc56cad-a24f-4d93-9522-86435029d494");
        ValidatableResponse jwtToken = jwtTokenAPI.jwtTokenWithValidRoles();
        ValidatableResponse response = api.getXml_APITest(jwtToken, jsonContent);
        response.statusCode(200);
        String responseBody = response.extract().asString();
    ...
    public void verifyBenchmarkId_FOUSA06WNW() throws IOException {
        ...
        String jsonFilePath = "src\\test\\resources\\testData\\RequestData\\ipx\\getXml.json";
        String jsonContent = new String(Files.readAllBytes(Paths.get(jsonFilePath)));
        jsonContent = jsonContent.replace("currentBenchmarkIdValue", "FOUSA06WNW")
                                 .replace("proposedBenchmarkIdValue", "FOUSA06WNW");
        ValidatableResponse jwtToken = jwtTokenAPI.jwtTokenWithValidRoles();
        ValidatableResponse response = api.getXml_APITest(jwtToken, jsonContent);
        response.statusCode(200);
        String responseBody = response.extract().asString();
    ...
    public void verifyBenchmarkId_Incorrect() throws IOException {
        ...
        String jsonFilePath = "src\\test\\resources\\testData\\RequestData\\ipx\\getXml.json";
        String jsonContent = new String(Files.readAllBytes(Paths.get(jsonFilePath)));
        jsonContent = jsonContent.replace("currentBenchmarkIdValue", "&9r89rnnkldf")
                                 .replace("proposedBenchmarkIdValue", "&9r89rnnkldf");
        ValidatableResponse jwtToken = jwtTokenAPI.jwtTokenWithValidRoles();
        ValidatableResponse response = api.getXml_APITest(jwtToken, jsonContent);
        response.statusCode(200);
        String responseBody = response.extract().asString();
    ...
    @MorningstarAutomationAnnotation(owner = "Ankit Yadav")
    @Test(groups = {Group.SMOKE, Group.FULL_REGRESSION})
    public void verifyReportsBasedOnReportFlag_Zero() throws IOException {
        AWS3_Reports_GetXML api = new AWS3_Reports_GetXML();
        AWS_authorizationToken_API jwtTokenAPI = new AWS_authorizationToken_API();
        String jsonFilePath = "src\\test\\resources\\testData\\RequestData\\ipx\\getXml.json";
        String jsonContent = new String(Files.readAllBytes(Paths.get(jsonFilePath)));
    ...
    @MorningstarAutomationAnnotation(owner = "Ankit Yadav")
    @Test(groups = {Group.SMOKE, Group.FULL_REGRESSION})
    public void verifyReportsBasedOnReportFlag_One() throws IOException {
        AWS3_Reports_GetXML api = new AWS3_Reports_GetXML();
        AWS_authorizationToken_API jwtTokenAPI = new AWS_authorizationToken_API();
        String jsonFilePath = "src\\test\\resources\\testData\\RequestData\\ipx\\getXml.json";
        String jsonContent = new String(Files.readAllBytes(Paths.get(jsonFilePath)));
