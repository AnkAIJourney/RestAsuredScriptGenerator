...
public class AWS3_IPX_Reports extends AbstractTest {
    ...
    public void verifyReportsBasedOnReportFlag_0() throws IOException {
        ...
        sAssert.assertFalse(responseBody.contains("<portcomprpt"), "Portfolio comparison report should not be present");
        sAssert.assertFalse(responseBody.contains("<xray"), "XRay should not be present");
        sAssert.assertFalse(responseBody.contains("<stockintsec"), "Stock intersection should not be present");
        sAssert.assertFalse(responseBody.contains("<mfdetail"), "MF detail should not be present");
        sAssert.assertFalse(responseBody.contains("<disclosurerpt"), "Disclosure report should not be present");
        sAssert.assertFalse(responseBody.contains("<transfeesingle"), "Single fee report should not be present");
        sAssert.assertFalse(responseBody.contains("<transfeeportfolio"), "Portfolio fee report should not be present");
        sAssert.assertFalse(responseBody.contains("<transfeeportcomp"), "Portfolio comparison fee should not be present");
    ...
    public void verifyReportsBasedOnReportFlag_1() throws IOException {
        ...
        sAssert.assertTrue(responseBody.contains("<portcomprpt"), "Portfolio comparison report should be present");
        sAssert.assertTrue(responseBody.contains("<xray"), "XRay should be present");
        sAssert.assertTrue(responseBody.contains("<stockintsec"), "Stock intersection should be present");
        sAssert.assertTrue(responseBody.contains("<mfdetail"), "MF detail should be present");
        sAssert.assertTrue(responseBody.contains("<disclosurerpt"), "Disclosure report should be present");
        sAssert.assertTrue(responseBody.contains("<transfeesingle"), "Single fee report should be present");
        sAssert.assertTrue(responseBody.contains("<transfeeportfolio"), "Portfolio fee report should be present");
        sAssert.assertTrue(responseBody.contains("<transfeeportcomp"), "Portfolio comparison fee should be present");
    ...
    public void validateCookies() throws IOException {
        ...
        String responseBody = response.extract().asString();
        sAssert.assertTrue(responseBody.contains("\"message\": \"Invlid cookie!\""), "Invalid cookie message not found");
        sAssert.assertAll();
    }
}
```