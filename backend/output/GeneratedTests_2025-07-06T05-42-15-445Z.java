...
public void Test_5() throws IOException {
    ...
    String xmlInput = new String(Files.readAllBytes(Paths.get(xmlFilePath)), StandardCharsets.UTF_8);
    ValidatableResponse jwtToken = jwtTokenAPI.jwtTokenWithValidRoles();
    xmlInput = xmlInput.replace("ACG-USA-BROAD-2", "");
    ValidatableResponse response = api.generateReport_APITest(jwtToken, xmlInput);
    ...
    xmlInput = new String(Files.readAllBytes(Paths.get(xmlFilePath)), StandardCharsets.UTF_8);
    xmlInput = xmlInput.replace("current", "");
    response = api.generateReport_APITest(jwtToken, xmlInput);
    response.statusCode(400);
    ...
    xmlInput = new String(Files.readAllBytes(Paths.get(xmlFilePath)), StandardCharsets.UTF_8);
    xmlInput = xmlInput.replace("IsGraph=1", "");
    response = api.generateReport_APITest(jwtToken, xmlInput);
    response.statusCode(400);
...
public void Test_6() throws IOException {
    ...
    String xmlInput = new String(Files.readAllBytes(Paths.get(xmlFilePath)), StandardCharsets.UTF_8);
    ValidatableResponse jwtToken = jwtTokenAPI.jwtTokenWithValidRoles();
    xmlInput = xmlInput.replace("ACG-USA-BROAD-2", "ACG-USA-DETAIL-2");
    ValidatableResponse response = api.generateReport_APITest(jwtToken, xmlInput);
    response.statusCode(500);
    ...
    xmlInput = new String(Files.readAllBytes(Paths.get(xmlFilePath)), StandardCharsets.UTF_8);
    xmlInput = xmlInput.replace("IsGraph=1", "IsGraph=false");
    response = api.generateReport_APITest(jwtToken, xmlInput);
    response.statusCode(400);
...
public void Test_8() throws IOException {
    ...
    String xmlInput = new String(Files.readAllBytes(Paths.get(xmlFilePath)), StandardCharsets.UTF_8);
    ValidatableResponse jwtToken = jwtTokenAPI.jwtTokenWithValidRoles();
    xmlInput = xmlInput.replace("ACG-USA-BROAD-2", "INVALID");
    ValidatableResponse response = api.generateReport_APITest(jwtToken, xmlInput);
    response.statusCode(500);
    sAssert.assertAll();
}
